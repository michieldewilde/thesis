...
Besturingssysteem virtualisatie is vooral bekend geworden door Docker vanaf 2013 (\cite{Hykes2013}). In het volgende hoofdstuk wordt verder ingegaan op containers en Docker.
...
Toch zijn er een paar andere problemen zoals aangehaald in \cite{Madhavapeddy2015}. Processen die als root werken kunnen niet geïsoleerd worden van elkaar. Verder wordt er ook aangehaald dat strengere isolatie nodig is. (tabel 2, \cite{Madhavapeddy2015})

\section{Docker}

Het was een kwestie van tijd dat de puzzelstukken in elkaar vielen. Dit gebeurde met Docker (\cite{Docker2016}). 

Docker was het bedrijf dat al de delen samenbracht onder uitgebreid ecosysteem. Het werd veel gemakkelijker om containers te maken en te delen met andere. Docker zorgde ervoor dat veel van moeilijkheden van containers verdwenen of veel kleiner werden. Door veel van de componenten van het ecosysteem open te stellen konden ze rekenen op de steun van vele ontwikkelaars. Deze steun kon zijn in de vorm van het melden van bugs of het uitbreiden of verbeteren van huidige componenten.
