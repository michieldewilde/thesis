...
Hun unikernel solution richt zich vooral op alles dat te maken heeft met netwerk trafiek. Je kan starten met het clickOS. Deze bestaat een modulaire software router waarop je alles kan toevoegen. Vroeger zat de laag die alles regelde met de netwerk trafiek eerder bij de hardware maar je kan dus ook je eigen implementatie schrijven om veel van functionaliteit van de hardware over te nemen. Dit zorgt voor een implementatie die een veel meer trafiek kan verwerken. Deze unikernels zijn rond de 6MB groot, starten op rond de 30 milliseconden en kunnen snel gebruikt worden 45 microseconden. Bij snel gebruikt bedoel ik dat ze worden toegevoegd om netwerk trafiek te verwerken.
